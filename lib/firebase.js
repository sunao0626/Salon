...
(function() {
	...
	P.prototype.k = function(a) {
		...
		if (a instanceof P)
			for (c = a.ba; c < a.n.length; c++) b.push(a.n[c]);
		else
	...
	P.prototype.da = function(a) {
		...
		for (var b = this.ba, c = a.ba; b <= this.n.length; b++, c++)
	...
	h.remove = function(a, b) {
		var c, d;
		c = this;
		if (0 > b(a, c.key)) c.left.e() || c.left.aa() || c.left.left.aa() || (c = Tc(c)), c = c.W(null, null, null, c.left.remove(a, b), null);
		else {
			c.left.aa() && (c = Uc(c));
	...
	Od.prototype.open = function(a, b) {
		...
		this.oa.onmessage = function(a) {
			if (null !== e.oa)
				if (a = a.data, e.kb +=
					a.length, Gd(e.Qa, "bytes_received", a.length), Qd(e), null !== e.frames) Rd(e, a);
				else {
					a: {
	...
	function ke(a, b) {
		return function(c) {
			if (2 != a.Pa)
				...
				if (d = zb("t", c), c = zb("d", c), "c" == d) "t" in c && (c = c.t, "a" === c ? se(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.C.close(), a.ad !== a.C && a.Xc !== a.C || a.close()) : "o" === c && (a.f("got pong on secondary."),
					a.tf--, se(a)));
	...
	h.jf = function() {
		...
		if (this.Eb) this.qc ? this.Dc && (3E4 < (new Date).getTime() - this.Dc && (this.Va = 1E3), this.Dc = null) : (this.f("Window isn't visible.  Delaying reconnect."), this.Va = this.xd, this.ue = (new Date).getTime()), a = Math.max(0, this.Va - ((new Date).getTime() - this.ue)), a *= Math.random(), this.f("Trying to reconnect in " +
			a + "ms"), ze(this, a), this.Va = Math.min(this.xd, 1.3 * this.Va);
		else
	...
	h.Sa = function(a, b, c, d, e, f) {
		...
		if (k !== a.F || l !== a.o)
			...
			else if (k && f && !c.e() && k.$(b).da(f.$(b))) g = !0;
